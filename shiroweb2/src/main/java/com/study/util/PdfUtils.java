...
public class PdfUtils {
    ...
    public static void main(String[] args) throws IOException {
        ...
        map.put("z_group","自动化");
        map.put("z_startTime","2020/2/22");
        map.put("z_endTime","2020/2/26");
        map.put("z_work","完成测试");
        map.put("z_position","佛山");
        map.put("z_worker","张三");
        map.put("z_homework","李四");
//        String path = PdfUtils.class.getResource("/template").getPath();
//        System.out.println("path:"+path);
//        String sourceFile = path + File.separator + "test.pdf";
        String sourceFile = "E:/uc.pdf";
        String targetFile = "E:/test.pdf";
